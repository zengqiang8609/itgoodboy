...
cmsAD_2.ADContent = "{'Images':[{'imgADLinkUrl':'http%3A%2F%2Fwww.phpcms.cn','imgADAlt':'phpcms专业建站系统','ImgPath':'http://localhost/itgoodboy/statics/images/v9/ad_login.jpg'}],'imgADLinkTarget':'New','Count':'1','showAlt':'Y'}"; 
cmsAD_2.URL = "http://localhost/itgoodboy/index.php?m=poster&c=index"; 
cmsAD_2.SiteID = 1; 
cmsAD_2.Width = 310; 
cmsAD_2.Height = 304; 
