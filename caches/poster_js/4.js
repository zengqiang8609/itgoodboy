...
cmsAD_4.ADContent = "{'Images':[{'imgADLinkUrl':'http%3A%2F%2Fwww.phpcms.cn','imgADAlt':'phpcms官方','ImgPath':'http://localhost/itgoodboy/uploadfile/poster/4.gif'}],'imgADLinkTarget':'New','Count':'1','showAlt':'Y'}"; 
cmsAD_4.URL = "http://localhost/itgoodboy/index.php?m=poster&c=index"; 
cmsAD_4.SiteID = 1; 
cmsAD_4.Width = 748; 
cmsAD_4.Height = 91; 
