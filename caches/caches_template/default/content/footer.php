...
<br />
<!--Powered by <strong><a href="<?php echo APP_PATH;?>" target="_blank">itgoodboy.com</a></strong> <em>V1.0.0</em> &copy; 2014-06-28 <img src="<?php echo IMG_PATH;?>copyright.gif"/><?php echo tjcode();?><?php echo runhook('glogal_footer')?>-->
&copy; 2014-06-28 <strong>itgoodboy.com</strong> 版权所有&nbsp;&nbsp;豫ICP备14014264号&nbsp;&nbsp;
